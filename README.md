...
* [`src/clj/bad_api/`](src/clj/bad_api/): Backend and middleware source files (Clojure,
[Compojure](https://github.com/weavejester/compojure))
* [`src/cljs/bad_api/`](src/cljs/bad_api/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/cljs/bad_api/core.cljs): contains the SPA entry point, `init`
...
7. Clone this repo and open a terminal in the `bad-api` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/bad_api/config.cljs) defaults to `true` in
...
```clj
(ns bad-api.example
  (:require [bad-api.config :as config])
...
```sh
port=2000 java -jar target/bad-api.jar
```
